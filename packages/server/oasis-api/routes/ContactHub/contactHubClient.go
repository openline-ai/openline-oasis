...
func ServeContactWs(feedId string, hub *ContactHub, w http.ResponseWriter, r *http.Request, pingInterval int) {
	...
	client := &ContactClient{hub: hub, conn: conn, send: make(chan []byte, 256), feedId: feedId, pongWait: pongWait, pingPeriod: pingPeriod}
